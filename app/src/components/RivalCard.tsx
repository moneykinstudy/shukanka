...
// Letter → Roman numeral mapping (higher rank → larger numeral)
const letterToRoman: Record<Rival['rankLabel'], keyof typeof romanIconMap> = {
  S:'X', A:'IX', B:'VIII', C:'VII', D:'VI', E:'V', F:'IV', G:'III', H:'II', I:'I'
};
...
export function RivalCard({ rival, onPress }: { rival: Rival; onPress?: ()=>void }){
  ...
  return (
    <TouchableOpacity activeOpacity={0.85} onPress={onPress}
      ...
      <View style={{ borderWidth:1.5, borderColor:'#D9E1EA', borderRadius:16, paddingVertical:10, paddingHorizontal:12, marginTop:12, alignItems:'center' }}>
        <Text style={{ color:'#555', marginBottom:6 }}>連続達成</Text>
        <Text style={{ fontSize:23, fontWeight:'900', letterSpacing:2 }}>{rival.streakDays} 日目</Text>
      </View>
    </TouchableOpacity>
  );
}
