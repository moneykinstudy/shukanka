...
if (!fs.existsSync(file)) {
  console.error('[patch-index] dist/index.html not found');
  process.exit(1);
}

let html = fs.readFileSync(file, 'utf8');
if (html.includes('ONBOARD_BOOT')) {
  console.log('[patch-index] ONBOARD_BOOT already present');
  process.exit(0);
}
...
console.log('[patch-index] injected ONBOARD_BOOT snippet');
